...
public class CustomerServiceImpl implements CustomerService {
	...
	public Customer update(Customer customer) {
		customerRepo.findById(customer.getUuid())
				.orElseThrow(() -> new NotFoundException("invalid customer id :" + customer.getUuid()));
		return customerRepo.save(customer);
	}

	@Override
	public Customer findById(String id) {
		return customerRepo.findById(id).orElseThrow(() -> new NotFoundException("invalid customer id : " + id));
	}
	...
	public String delete(String id) {
		customerRepo.findById(id).orElseThrow(() -> new NotFoundException("invalid customer id : " + id));
